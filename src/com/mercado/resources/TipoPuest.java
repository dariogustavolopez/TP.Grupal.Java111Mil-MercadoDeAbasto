...
/**
 * TipoPuest generated by hbm2java
 */
public class TipoPuest  implements java.io.Serializable {
    ...
    public TipoPuest(int idTipoPuesto, String nombre) {
        this.idTipoPuesto = idTipoPuesto;
        this.nombre = nombre;
    }
    public TipoPuest(int idTipoPuesto, String nombre, String descripcion, Set precioalquilers) {
       this.idTipoPuesto = idTipoPuesto;
       this.nombre = nombre;
